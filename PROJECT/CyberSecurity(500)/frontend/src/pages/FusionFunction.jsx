...
const FusionFunction = () => {
  ...
  const [masterInput, setMasterInput] = useState({ correlationData: '', eventData: '' });
  ...
  useEffect(() => {
    if (location.state) {
      ...
      setInput(location.state.masterInput.correlationData || location.state.masterInput.eventData || '');
    }
  }, [location.state]);
        ...
        case 'correlation':
          result = {
            ...
            data: {
              ...
              attackChains: Math.floor(Math.random() * 5) + 1,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <span className={`px-3 py-1 rounded-full text-sm font-medium ${
            functionData.category === 'correlation' ? 'bg-neon-cyan/20 text-neon-cyan' :
            functionData.category === 'aggregation' ? 'bg-plasma-green/20 text-plasma-green' :
            functionData.category === 'processing' ? 'bg-quantum-purple/20 text-quantum-purple' :
            functionData.category === 'analysis' ? 'bg-fusion-orange/20 text-fusion-orange' :
      ...
      <div className="card-cyber">
        ...
        <div className="space-y-4">
          ...
          {masterInput.correlationData && (
            <div>
              <label className="block text-sm font-medium text-text-primary mb-2">
                Master Correlation Data Input
              </label>
              <textarea
                value={masterInput.correlationData}
                readOnly
          ...
          {masterInput.eventData && (
            <div>
              <label className="block text-sm font-medium text-text-primary mb-2">
                Master Event Data Input
              </label>
              <textarea
                value={masterInput.eventData}
                readOnly
                className="input-cyber w-full h-32 bg-dark-surface/50"
                rows={4}
              />
          ...
          <div>
            ...
            <input
              ...
              placeholder={functionData.inputExample || "Enter data for this function..."}
