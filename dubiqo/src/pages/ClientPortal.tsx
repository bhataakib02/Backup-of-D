...
const ClientPortal = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (loginData.email.toLowerCase().includes("admin")) {
      toast({
        title: "Admin Access",
        description: "Admin users should login through the admin portal. Redirecting...",
        variant: "default",
      });
      setIsLoading(false);
    ...
    // Demo login (accept any credentials for demo, except admin)
    setIsLoggedIn(true);
    toast({
      title: "Welcome Back! ✓",
