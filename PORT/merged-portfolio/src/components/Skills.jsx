    ...
    <section className="py-20 px-4 bg-transparent" id="skills">
      <div className="text-center mb-12 space-y-4 max-w-3xl mx-auto">
        ...
        <h2 className="section-title text-gray-900 dark:text-white">
          🛠️ A secure-first engineering toolbox.
        </h2>
        <p className="section-subtitle">
          These are the frameworks, languages, and tools I reach for every day, battle-tested across
          academic collaborations, freelance work, and hackathons.
        </p>
      </div>
