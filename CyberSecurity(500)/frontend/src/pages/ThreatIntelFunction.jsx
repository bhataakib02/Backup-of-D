...
const ThreatIntelFunction = () => {
  const { id } = useParams();
  const location = useLocation();
  const navigate = useNavigate();
  
  const [functionData, setFunctionData] = useState(null);
  const [masterInput, setMasterInput] = useState({ intelData: '', indicator: '' });
  ...
  useEffect(() => {
    if (location.state) {
      ...
      setInput(location.state.masterInput.intelData || location.state.masterInput.indicator || '');
    }
  }, [location.state]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <span className={`px-3 py-1 rounded-full text-sm font-medium ${
            functionData.category === 'reputation' ? 'bg-neon-cyan/20 text-neon-cyan' :
            functionData.category === 'ioc' ? 'bg-plasma-green/20 text-plasma-green' :
            functionData.category === 'feed' ? 'bg-quantum-purple/20 text-quantum-purple' :
      ...
      <div className="card-cyber">
        ...
        <div className="space-y-4">
          ...
          {masterInput.intelData && (
            <div>
              <label className="block text-sm font-medium text-text-primary mb-2">
                Master Intelligence Data Input
              </label>
              <textarea
                value={masterInput.intelData}
                readOnly
          ...
          {masterInput.indicator && (
            <div>
              <label className="block text-sm font-medium text-text-primary mb-2">
                Master Indicator Input
              </label>
              <input
                type="text"
                value={masterInput.indicator}
                readOnly
          ...
          <div>
            ...
            <input
              ...
              placeholder={functionData.inputExample || "Enter indicator or intelligence data for this function..."}
...
export default ThreatIntelFunction;
