        ...
        case 'botnet':
          result = {
            ...
            data: {
              ...
              c2Servers: Math.floor(Math.random() * 20) + 1,
              infectedHosts: Math.floor(Math.random() * 500) + 50
            },
            executionTime: executionTime
          };
          break;
        case 'zero-day':
          result = {
            ...
            data: {
              ...
              vulnerabilities: Math.floor(Math.random() * 15) + 1,
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <span className={`px-3 py-1 rounded-full text-sm font-medium ${
            functionData.category === 'ueba' ? 'bg-neon-cyan/20 text-neon-cyan' :
            functionData.category === 'soar' ? 'bg-plasma-green/20 text-plasma-green' :
            functionData.category === 'xai' ? 'bg-quantum-purple/20 text-quantum-purple' :
            functionData.category === 'botnet' ? 'bg-fusion-orange/20 text-fusion-orange' :
            functionData.category === 'zero-day' ? 'bg-danger-red/20 text-danger-red' :
            functionData.category === 'predictive' ? 'bg-warning-yellow/20 text-warning-yellow' :
            functionData.category === 'soc' ? 'bg-electric-blue/20 text-electric-blue' :
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter data for this advanced function..."
